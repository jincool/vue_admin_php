...
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('1', '党费上划', '0', '0');
INSERT INTO `menu` VALUES ('2', '党费下拨', '2', '0');
INSERT INTO `menu` VALUES ('3', '党费缴纳', '4', '0');
...
INSERT INTO `menu_sub` VALUES ('3', '2', '下拨申请', 'down_apply', '0', '0');
INSERT INTO `menu_sub` VALUES ('4', '2', '下拨审核', 'down_check', '1', '0');
INSERT INTO `menu_sub` VALUES ('5', '3', '党费缴纳', 'pay_money', null, '0');
INSERT INTO `menu_sub` VALUES ('6', '4', '菜单设置', 'system_menu', null, '0');
INSERT INTO `menu_sub` VALUES ('112', '4', '角色设置', 'system_role', null, '0');
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES ('1', '三级管理员', '0');
INSERT INTO `role` VALUES ('2', '普通用户', '0');
INSERT INTO `role` VALUES ('3', '系统管理员', '0');
INSERT INTO `role` VALUES ('4', '2', '1');
INSERT INTO `role` VALUES ('5', '等等', '1');
INSERT INTO `role` VALUES ('6', 'dd ', '1');
INSERT INTO `role` VALUES ('7', '市委', '1');
...
CREATE TABLE `role_menu` (
  ...
  `is_delete` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='角色菜单表';

-- ----------------------------
-- Records of role_menu
-- ----------------------------
INSERT INTO `role_menu` VALUES ('1', '1', '1', '1', '0');
INSERT INTO `role_menu` VALUES ('2', '1', '1', '2', '0');
INSERT INTO `role_menu` VALUES ('3', '1', '2', '3', '0');
INSERT INTO `role_menu` VALUES ('4', '1', '2', '4', '0');
INSERT INTO `role_menu` VALUES ('5', '2', '3', '5', '0');
INSERT INTO `role_menu` VALUES ('6', '3', '4', '6', '0');
INSERT INTO `role_menu` VALUES ('7', '3', '4', '112', '0');
